...
export function AutomobileClientComponent({ products }: ClientComponentProps) {
              ...
              {currentProducts.map((product) => (
                ...
                >
                  ...
                  <div className="p-4 flex flex-col grow">
                    ...
                    {/* MOQ Badge */}
                    <div className="inline-flex items-center gap-1 px-3 py-1 bg-blue-100/50 text-blue-700 text-xs font-medium rounded-full">
