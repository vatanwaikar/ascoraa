...
export function AgricultureClientComponent({ products }: ClientComponentProps) {
              ...
              {currentProducts.map((product) => (
                ...
                >
                  ...
                  <Link href={`/products/${product.slug}`}>
                    <div className="h-40 w-full overflow-hidden cursor-pointer">
                      <img
                        src={product.image}
                        alt={product.name}
                  ...
                  <div className="p-4 flex flex-col grow">
                    ...
                    {/* MOQ Badge */}
                    <div className="inline-flex items-center gap-1 px-3 py-1 bg-green-100/50 text-green-700 text-xs font-medium rounded-full">
